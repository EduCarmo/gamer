  ...
  return (
    <footer className="flex flex-col bg-black/30 text-zinc-400 mt-10">
      ...
      <div className="container flex flex-col py-10 gap-10">
        <div
          className={`
            flex flex-col items-center  justify-between text-center gap-5
            md:flex-row md:items-start md:text-left md:gap-0
            `}
        >
          <Logo />
          <div className="flex flex-col gap-1">
            ...
            <span className="text-sm">Política de Privacidade</span>
          ...
          <div className="flex flex-col gap-1">
            ...
            <span className="text-sm">suporte@gam3er.store</span>
